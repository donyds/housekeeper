                ...
                <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td class="innerpadding borderbottom" align="center">
                            <img class="fix" src="<?php echo base_url();?>/assets/images/logo.png" width="auto" height="100%" border="0" alt="" />
                        </td>
                    </tr>
                    <tbody>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td valign="top" height="25" width="100" style="font-size: 18px; color: rgb(51, 51, 51); font-weight: normal; text-align: left; font-family: &quot;Open Sans&quot;, Arial, Helvetica, sans-serif; word-break: break-word; line-height: 120%; cursor: text;" panel-color="color_table" editor="content" class="relative_index2">
                                                                <span style="    text-decoration: none;line-height: 24px;font-size: 30px;color: rgb(51, 51, 51);font-weight: bold;">Enquiry Details</span>
                                                            </td>
                                                        </tr>
                                                        <!-- start space -->
                                                        <tr>
                                            ...
                                            <td valign="top" style="padding-left: 20px; padding-right: 20px;">
                                                <table width="100%" edit-style="color_table" align="center" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <!-- end space -->
                                                        <tr>
                                                            <td valign="top" height="25" width="100" style="font-size: 14px; color: rgb(136, 136, 136); font-weight: normal; text-align: left; font-family: &quot;Open Sans&quot;, Arial, Helvetica, sans-serif; word-break: break-word; line-height: 140%;" panel-color="color_table" editor="content" class="relative_index2">
                                                                Your msg:
                                                            </td>
                                                            <td valign="top">
                                                                <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="height:100%;">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td valign="top" style="font-size: 14px; color: rgb(51, 51, 51); font-weight: normal; text-align: justify; font-family: &quot;Open Sans&quot;, Arial, Helvetica, sans-serif; word-break: break-word; line-height: 140%;" panel-color="color_table" editor="content" class="relative_index2">
                                                                            <?php echo $myinfo['msg'];?>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" class="footercopy">
                                        <span class="hide">© 2022 - All Rights Reserved House keeper <br> Designed &amp; Developed By<a href="https://www.developerbazaar.com"><span style="color: red;"> Developer </span><span style="color: limegreen;"> Bazaar</span> <span style="color: red;"> Technologies </span></a></span>
                                    </td>
                                </tr>
                                <!-- <tr>
